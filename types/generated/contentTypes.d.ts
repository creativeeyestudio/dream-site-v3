...
export interface ApiLegalNoticeLegalNotice extends Schema.SingleType {
  ...
  attributes: {
    ...
    host_name: Attribute.Enumeration<['IONOS', 'OVH', 'Sapinet']>;
    legal_status: Attribute.Enumeration<['SAS', 'SASU', 'SARL', 'EURL']> &
      Attribute.Required;
    phone: Attribute.String;
    publishedAt: Attribute.DateTime;
    siret_number: Attribute.String & Attribute.Required;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::legal-notice.legal-notice',
      'oneToOne',
